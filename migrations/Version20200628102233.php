 ...
 */
final class Version20200628102233 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE delivery (id INT AUTO_INCREMENT NOT NULL, age_min SMALLINT NOT NULL, age_max SMALLINT DEFAULT NULL, price SMALLINT NOT NULL, created_at DATETIME NOT NULL, archived TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE delivery_type (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(30) NOT NULL, forkids TINYINT(1) NOT NULL, foradults TINYINT(1) NOT NULL, archived TINYINT(1) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE party (id INT AUTO_INCREMENT NOT NULL, organised_by_id INT NOT NULL, date DATE NOT NULL, hour_start TIME NOT NULL, hour_end TIME DEFAULT NULL, child_age SMALLINT NOT NULL, children_number SMALLINT NOT NULL, place_type VARCHAR(50) NOT NULL, moderate TINYINT(1) DEFAULT NULL, archived TINYINT(1) NOT NULL, INDEX IDX_89954EE09A82C896 (organised_by_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE pro (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(60) NOT NULL, lastname VARCHAR(70) NOT NULL, gender VARCHAR(10) DEFAULT NULL, firm VARCHAR(60) DEFAULT NULL, departement_shifting SMALLINT NOT NULL, mobilephone SMALLINT NOT NULL, otherphone SMALLINT DEFAULT NULL, created_at DATETIME NOT NULL, archived TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_6BB4D6FFE7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE user (id INT AUTO_INCREMENT NOT NULL, email VARCHAR(180) NOT NULL, roles LONGTEXT NOT NULL COMMENT \'(DC2Type:json)\', password VARCHAR(255) NOT NULL, firstname VARCHAR(60) NOT NULL, lastname VARCHAR(50) NOT NULL, gender VARCHAR(10) NOT NULL, postalcode SMALLINT UNSIGNED NOT NULL, city VARCHAR(50) NOT NULL, departement SMALLINT NOT NULL, mobilephone SMALLINT NOT NULL, otherphone SMALLINT DEFAULT NULL, moderate TINYINT(1) DEFAULT NULL, createdat DATETIME NOT NULL, archived TINYINT(1) NOT NULL, UNIQUE INDEX UNIQ_8D93D649E7927C74 (email), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
